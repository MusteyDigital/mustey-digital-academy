        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-5">
                ...
                <form method="POST" action="{{ route('quizzes.store', $course->id) }}" class="space-y-5">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1">Attach to Lesson (Optional)</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1">Pass Mark (%)</label>
                            <input type="number"
                                   name="pass_mark"
                                   min="0"
                                   max="100"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1">Attempt Limit</label>
                            <input type="number"
                                   name="max_attempts"
                                   min="1"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <input type="checkbox" name="is_published" value="1" id="is_published" class="rounded border-slate-300 text-blue-600 focus:ring-blue-500">
